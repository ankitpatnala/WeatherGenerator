...
from weathergen.train.target_and_aux_forecast_latent import ForecastLatentTarget
...
def get_target_aux_calculator(
    ...
    elif target_and_aux_calc == "ForecastLatentTarget":
        target_aux = ForecastLatentTarget(loss_cfg, model)
