...
def write_output(
    ...
    target_channels: list[list[str]] = [list(stream.val_target_channels) for stream in data_streams]
    source_channels: list[list[str]] = [list(stream.val_source_channels) for stream in data_streams]

    geoinfo_channels = [[] for _ in data_streams]  # TODO obtain channels
