...
def get_condition_type(stream_type: str) -> object | None:
    ...
    match stream_type:
        case "condition":
            from weathergen.readers_extra.data_reader_condtion import DataReaderCondition
            return DataReaderCondition
        case _:
            return None
